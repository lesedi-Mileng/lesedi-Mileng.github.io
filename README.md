...
<body>
  <div class="container">
    ...
    <!-- Header -->
    <div class="header">
      <img src="lesedi.jpg" alt="Lesedi Mileng Profile Picture" />
      <div>
        <h1>Lesedi Mileng</h1>
        <div class="contact">
...
student, with a solid foundation in 
backend development. Proficient in 
Java, Python, C#, and C++, with 
firsthand experience through 
academic projects that have honed 
both technical and teamwork skills. 
Eager to launch a career in software 
development or programming, with a 
long-term goal of contributing to 
innovative, scalable solutions that 
drive technological progress and 
improve lives.
      </p>
    </div>
    ...
    <div class="section-box">
      ...
      <p><strong>BSc in Information Technology</strong> (2023–2025)<br>North-West University</p>
      <p><strong>High School</strong> (2018–2022)<br>Curro Academy Mahikeng</p>
    </div>
...
efficient data handling.
    ...
    <div class="section-box">
      ...
      <ul>
        <li>Ratau Men's Residence FNAS Top Achiever – 3rd Place (2023)</li>
        <li>NWU 2nd team Soccer Residence League Champion – 2023, 2024</li>
    ...
    <div class="section-box">
      ...
      <p>Basketball, soccer, gaming, working out, reading books</p>
    </div>
